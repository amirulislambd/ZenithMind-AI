...
import { ArrowLeft, CalendarDays, MapPin, Star, Sparkles } from "lucide-react";
...
async function getItem(id: string) {
  ...
  return response.data as { item: IWellnessItem; relatedItems: IWellnessItem[] } | null;
}
...
export default async function ItemDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const { item, relatedItems } = itemData;
